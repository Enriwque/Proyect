...
export default function Personaje() {
  ...
  return (
    <>
      <div className="main-info" id="surface">
        ...
        <a href="#bottom"><button className="toggle-comment" id="mobile">Bajar</button></a>
      ...
      <div className="deep-info">
        ...
        <a href="#surface"><button className="toggle-comment" id="mobile" >Subir</button></a>
        <div id="bottom"><h2>Galería</h2></div>
      </div>
      <Galeria charId={character.id} />
    </>
  )
}